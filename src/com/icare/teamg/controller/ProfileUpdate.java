...
import com.icare.teamg.model.UpdateData;
...
public class ProfileUpdate extends HttpServlet {
	...
	temp.add("");
	temp.add(type);
	System.out.println(firstname + " Type " + type);
	UpdateData updateData = new UpdateData();
	updateData.updateData(type, firstname, lastname, dob, age, address, phonenumber, name);
